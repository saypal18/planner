...
public class MyAdapter2 extends RecyclerView.Adapter<MyHolder> {
    ...
    public MyAdapter2(Context c, ArrayList<Model> models) {
        this.c = c;
        this.models = models;
    }
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Intent myIntent = new Intent(c, SubTaskDetail.class);
                myIntent.putExtra("stparentname", task); //Optional parameters
